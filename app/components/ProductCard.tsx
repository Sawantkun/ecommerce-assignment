    ...
    >
      ...
      <div className="relative p-6 pb-4">
        ...
        <div className="space-y-3 relative z-10">
          <h2 className="text-lg font-semibold text-gray-800 line-clamp-2 leading-tight group-hover:text-blue-600 transition-colors duration-200">
            {product.title}
          </h2>
      ...
      <div className="px-6 pb-6 relative z-10">
        <Link href={`/product/${product.id}`}>
          <motion.button
            ...
            className="w-full relative overflow-hidden bg-gradient-to-r from-blue-500 via-blue-600 to-indigo-600 text-white py-3 rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300 group/button"
          >
